$(function(){
    ...
    $("#navon0").click(function(){
	   $("html,body").animate({scrollTop:$("#div0").offset().top},100);

	})
	$("#navon1").click(function(){
	   $("html,body").animate({scrollTop:$("#div1").offset().top},100);

	})
	$("#navon2").click(function(){
	   $("html,body").animate({scrollTop:$("#div2").offset().top},100);
	})
    $("#navon3").click(function(){
	  $("html,body").animate({scrollTop:$("#div3").offset().top},100);   
	})
	$("#navon4").click(function(){
	  $("html,body").animate({scrollTop:$("#div4").offset().top},100);   
	})
    $("#navon5").click(function(){
	  $("html,body").animate({scrollTop:$("#div5").offset().top},100);   
	})
	$("#navon6").click(function(){
	  $("html,body").animate({scrollTop:$("#div6").offset().top},100);   
	})
